...
const CookieVisitas = () => {
    ...
    return (
        <div className={styles.divContainer}>
            ...
            <svg width="36" height="200" viewBox="0 0 36 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="Group1" className={styles.group1}>
                <ellipse id="Ellipse1" cx="18" cy="10.5" rx="18" ry="10.5" fill="#D9D9D9"/>
                <ellipse id="Ellipse2" cx="17.5" cy="11" rx="6.5" ry="5" fill="black"/>
                </g>
            </svg>
